...
HD_PWD='/home/lucasml/Escritorio/CESE/Microarquitecturasysoftcores/Laboratorios/laboratorio4/laboratorio4.runs/system_VGA_CONTROLLER_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_VGA_CONTROLLER_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_VGA_CONTROLLER_0_0.tcl
