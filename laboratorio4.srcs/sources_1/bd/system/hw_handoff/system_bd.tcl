...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set blue_out [ create_bd_port -dir O -from 2 -to 0 blue_out ]
  set flagneghsync_o [ create_bd_port -dir O flagneghsync_o ]
  set flagnegvsync_o [ create_bd_port -dir O flagnegvsync_o ]
  set green_out [ create_bd_port -dir O -from 2 -to 0 green_out ]
  set red_out [ create_bd_port -dir O -from 2 -to 0 red_out ]
  ...
  # Create instance: system_clk_wiz_0_0_synth_1, and set properties
  set system_clk_wiz_0_0_synth_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 system_clk_wiz_0_0_synth_1 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins VGA_CONTROLLER_0/CONTROLLER_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net switches_GPIO [get_bd_intf_ports switches] [get_bd_intf_pins switches/GPIO]

  # Create port connections
  connect_bd_net -net VGA_CONTROLLER_0_blue_out [get_bd_ports blue_out] [get_bd_pins VGA_CONTROLLER_0/blue_out]
  connect_bd_net -net VGA_CONTROLLER_0_flagneghsync_o [get_bd_ports flagneghsync_o] [get_bd_pins VGA_CONTROLLER_0/flagneghsync_o]
  connect_bd_net -net VGA_CONTROLLER_0_flagnegvsync_o [get_bd_ports flagnegvsync_o] [get_bd_pins VGA_CONTROLLER_0/flagnegvsync_o]
  connect_bd_net -net VGA_CONTROLLER_0_green_out [get_bd_ports green_out] [get_bd_pins VGA_CONTROLLER_0/green_out]
  connect_bd_net -net VGA_CONTROLLER_0_red_out [get_bd_ports red_out] [get_bd_pins VGA_CONTROLLER_0/red_out]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins VGA_CONTROLLER_0/entrada1_in] [get_bd_pins system_clk_wiz_0_0_synth_1/clk_out1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins VGA_CONTROLLER_0/controller_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins buttons/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins switches/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins VGA_CONTROLLER_0/controller_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins buttons/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins switches/s_axi_aresetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins system_clk_wiz_0_0_synth_1/clk_in1]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs VGA_CONTROLLER_0/CONTROLLER_AXI/CONTROLLER_AXI_reg] SEG_VGA_CONTROLLER_0_CONTROLLER_AXI_reg
